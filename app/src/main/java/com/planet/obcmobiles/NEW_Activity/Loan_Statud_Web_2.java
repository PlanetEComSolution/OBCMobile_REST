...
public class Loan_Statud_Web_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   webview.loadUrl("http://121.241.255.225/obcnew/site/getolsleaddetails.aspx");
        webview.loadUrl(Utility.URL_OLS_DETAILS_2);
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message,
            ...
            new AlertDialog.Builder(Loan_Statud_Web_2.this)
                    .setTitle("")
                    .setMessage(message)
